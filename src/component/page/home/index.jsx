      ...
      <div className={grid.row}>
        <div className={grid.col + ' ' + grid.col10}>
          <Typography__Section_Title
            text='BCD is a methodology to organise and manage components. It encourages consistency and provides complete control over each component idependently. The system is split into three libraries; Assets, Behaviours and Components.'
          />
        </div>
      </div>
